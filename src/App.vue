    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <hr>
                <button class="btn btn-primary" @click="addItem">AddItem</button>
                <br><br>
                <ul class="list-group">
...
<style>
    /* This is only attached for one frame at the beginning, this class will be inmmediately removed after one frame */
    .fade-enter {
        opacity: 0;
    }
